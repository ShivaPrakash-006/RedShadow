...
PAUSE = pygame.image.load("PauseButton.png")
CRYSTAL = pygame.image.load("SpaceShips/Crystal/Crystal.png")
ARROW = pygame.image.load("SpaceShips/ArrowHead/ArrowHead.png")
HELIX = pygame.image.load("SpaceShips/Helix/Helix.png")
SHIP1 = CRYSTAL
SHIP2 = pygame.image.load("SpaceShips/Enemy.png")
...
#FONTS
FONT = pygame.font.Font("SourceCodePro-Medium.ttf", 16)
FONT2 = pygame.font.Font("SourceCodePro-SemiBold.ttf", 20)
...
def upgrades():
    run = True
    state = "Menu"
    with open('Upgrades/upgrades.dat', 'rb') as f:
    ...
    def draw(ship, ship_name, ship_state, data):
        ...
        #BUTTONS
        WIN.blit(pygame.transform.scale2x(pygame.transform.rotate(pygame.image.load('Upgrades/ArrowButton.png'), -90)),back_button)
        WIN.blit(pygame.transform.scale2x(pygame.transform.rotate(pygame.image.load('Upgrades/ArrowButton.png'), 90)), next_button)
        WIN.blit(pygame.transform.scale2x(pygame.transform.rotate(pygame.image.load('Upgrades/ArrowButton.png'), -90)), prev_button)
        WIN.blit(pygame.transform.scale2x(pygame.image.load('Upgrades/ArrowButton.png')), down_button)
        WIN.blit(pygame.transform.scale2x(pygame.transform.rotate(pygame.image.load('Upgrades/ArrowButton.png'), 180)),up_button)
        WIN.blit(pygame.transform.scale2x(pygame.image.load('Upgrades/UpgradeButton.png')),upgrade_button)
        WIN.blit(pygame.transform.scale2x(pygame.image.load('Upgrades/DegradeButton.png')),degrade_button)
        if not ship_state:
    ...
    with open('Upgrades/upgrades.dat', 'wb') as f:
        upgrade_data[ship] = [upgrade_queue, upgrade_unlocked, upgrade_max, upgrade_min, ship_unlocked]
...
def scores():
    ...
    def draw(scores, search):
        ...
        #BUTTONS
        WIN.blit(pygame.transform.rotate(pygame.transform.scale2x(pygame.image.load("Upgrades/ArrowButton.png")), -90), back_button)
...
def game(game_state):
    ...
    run = True
    hit = False
    f = open("Upgrades/upgrades.dat", 'rb')
    data = pickle.load(f)
...
#        print(c_powerup)
        ...
        if keys[pygame.K_k] and slow_fuel > 0:
            ...
            if ((keys[pygame.K_UP] or keys[pygame.K_w]) and Player.y - PLAYER_P > 0) and ((keys[pygame.K_RIGHT] or keys[pygame.K_d])  and Player.x + PLAYER_W + PLAYER_P < WIDTH): #UPRIGHT
                Player.x += PLAYER_P
                Player.y -= PLAYER_P
                SHIP1 = pygame.image.load(f"SpaceShips/{ship}/FR.png")
                ...
                Player.x -= PLAYER_P
                Player.y -= PLAYER_P
                SHIP1 = pygame.image.load(f"SpaceShips/{ship}/FL.png")
                ...
                Player.x += PLAYER_P
                Player.y += PLAYER_P
                SHIP1 = pygame.image.load(f"SpaceShips/{ship}/DR.png")
